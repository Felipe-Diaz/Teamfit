...
from .views import development_Buttons, llenar_DB, iniciar_sesion, crear_usuarios, graficar_Datos, pagina_principal, cerrar_sesion, subirProyectos, ver_proyectos #asd
urlpatterns = [ 
