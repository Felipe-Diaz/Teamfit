...
class Ventas(models.Model):
    ...
    def __str__(self):
        return self.id + " - " + self.idTipoProyecto + " - " + self.fecha
...
class Hh_Estimado_Detalle_Semanal(models.Model):
    id = models.AutoField(primary_key=True, default=0, verbose_name="ID Estimado Detalle Semanal")
    fecha = models.DateTimeField(null=False, blank=False, default=datetime.now(), verbose_name="Fecha")
    anio = models.IntegerField(null=False, blank=False, default=2024, verbose_name="Año")
    semana = models.IntegerField(null=False, blank=False, default=31, verbose_name="Semana")
    ...
    def __str__(self):
        return self.id + " - " + self.anio + "/" + self.semana
